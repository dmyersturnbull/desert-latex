...
\begin{itemize}
    ...
    \item tarmac: Loads and seriously patches \ctan{setspace}, and provides a \verb|\Tarmac| macro
...
\begin{LongTable} [
    ...
    note{c}                = {
        ...
        Refer to \ctan{fancyhdr} for more info.
    } ,
    remark{Categories}     = {
...
pkg / \ctan{tikz-cd} & - & Commutative diagrams  \\
pkg / \ctan{cryptocode} & - &  Lots of things \\
pkg / \ctan{imakeidx} & - & Make an index  \\
pkg / \ctan{csvsimple} & - & \link{https://mirrors.ctan.org/macros/latex/contrib/csvsimple/csvsimple-l3.pdf}[csvsimple-l3] \\
pkg / \ctan{knowledge} & - & Hyperlinks to topics, etc.  \\
pkg / \ctan{fontawesome5} & - & \link{https://fontawesome.com/}[fontawesome]  \\
...
font / faces & \codeopts{LatinModern, STIX+LatinModern, STIX+SourceSans, STIX+NOTO} & preselected font setup (or use \ctan{fontspec} commands)
...
layout / fnote-align & \codeopts{left,right,center} &   \\
