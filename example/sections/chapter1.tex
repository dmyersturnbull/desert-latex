...
As Johnson herself once said, \Quote[cite=johnson2022]{life is good}.
...
%\begin{Quotation}[]  % default style for env is display (choices are text, display, and block (default))
