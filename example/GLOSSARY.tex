...
\NomMath {A \circ B} {Morphological opening of $A$ by $B$}<https://en.wikipedia.org/wiki/Opening\_(morphology)>
...
\DeclareAcronym {CRISPR} {long=clustered regularly interspaced short palindromic repeats}
\DeclareAcronym {MOA} {
